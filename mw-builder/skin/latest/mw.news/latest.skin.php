...
.<?=$style_name?> ul { margin:0 0 7px 7px; padding:0; list-style:none; font:normal 12px 'gulim'; letter-spacing:0; }
...
.<?=$style_name?> ul li span.comment { color:#FF6600; font:normal 10px 'dotum'; letter-spacing:-1px; }
...
<tr><td valign="top">
    ...
    <a href="<?=$g4[bbs_path]?>/board.php?bo_table=<?=$bo_table?>"><div class="mw_date_image"><?=print_date_image()?></div></a>
