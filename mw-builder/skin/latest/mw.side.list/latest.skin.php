...
.<?php echo $style_name?> .box { margin:0 5px 5px 5px; padding:7px 0 5px 0; border:1px solid #e1e1e1; background-color:#fff; }
.<?php echo $style_name?> ul { margin:0; padding:0; list-style:none;  }
.<?php echo $style_name?> ul li { margin:0 0 0 7px; padding:0 0 0 7px; background:url(<?php echo $latest_skin_path?>/img/dot.gif) no-repeat 0 7px; height:20px; clear:both; line-height:20px; }
