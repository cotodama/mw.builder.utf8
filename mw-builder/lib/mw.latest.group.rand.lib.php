...
// 최신글 추출 (캐쉬적용)
function mw_latest_group_rand($skin_dir="", $gr_id, $rows=10, $subject_len=40, $is_img=0, $minute=0)
{
    global $g4, $mw;
	...
	$sql = "select *
		 ...
		 where bo_table in ('$sql_tables') and bf_type > 0 and bf_type < 4 and bf_no = 0
